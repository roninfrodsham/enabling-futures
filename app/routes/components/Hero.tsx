    ...
    <Container className="pt-10 pb-16 text-center">
      ...
      Providing the{' '}
        <span className="relative whitespace-nowrap text-sky-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-yellow-400/50"
          ...
          <span className="relative">very best</span>
        </span>{' '}
      ...
      {/* <div className="mt-20">
        ...
        >
          {[
            [
              { name: 'Manchester City Council', logo: mcc },
              { name: 'Stockport Metropolitan Borough Council', logo: smbc },
              { name: 'Trafford Council', logo: tc },
            ],
            [
              { name: 'Cheshire East Council', logo: cec },
              { name: 'Tameside Metropolitan Borough Council', logo: tcc },
              { name: 'Doncaster Council', logo: dcc }
            ],
